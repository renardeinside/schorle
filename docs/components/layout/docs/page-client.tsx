    ...
    <div
      ...
      style={{
        ...
        insetInlineEnd: collapsed
          ? "max(0px, calc(50vw - var(--fd-sidebar-width)/2 - var(--fd-page-width)/2 - var(--fd-left-sidebar-width, 0px)))"
          : "max(var(--fd-layout-offset), calc(50vw - var(--fd-sidebar-width)/2 - var(--fd-page-width)/2 - var(--fd-left-sidebar-width, 0px)))",
      }}
    >
