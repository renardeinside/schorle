...
export function Navbar(props: ComponentProps<"div">) {
  ...
  return (
    <NavigationMenu value={value} onValueChange={setValue} asChild>
      ...
      >
        <NavigationMenuList className="flex h-14 w-full items-center" asChild>
  ...
  return (
    <NavigationMenuLink asChild>
      <Link
        {...props}
        className={cn(
          "flex flex-col gap-2 rounded-lg bg-fd-card p-3 transition-colors hover:bg-fd-accent/80 hover:text-fd-accent-foreground",
          props.className,
        )}
      >
        {props.children}
